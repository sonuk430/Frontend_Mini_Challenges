...
const ImageGallery = () => {
  ...
  const imgUrl =
    selectedImg !== null && selectedImg >= 0 && selectedImg < imgData.length
      ? imgData[selectedImg].label
      : null;
  function handleImgSelected(index) {
    return () => {
  ...
  return (
    <div className={styles.imgWrapper}>
      <Img img={img} onClickOnImg={handleImgSelected} />
      <SelectedImg imgUrl={imgUrl} />
    </div>
  );
};
